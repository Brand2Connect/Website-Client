...
export default function UnstyledButtonsSimple(props) {
  ...
  return (
    <Stack spacing={2} direction="row">
       <BootstrapButton  onClick = {props.onClick} hover = {props.hover}  rounded = {props.rounded} backgroundColor = {props.backgroundColor} colors = {props.colors}>  
       {props.text}
      </BootstrapButton>
...
const BootstrapButton = styled(Button)(({ theme, backgroundColor,hover,rounded,colors }) => ({
  fontSize: '0.8rem',
  padding: '15px 65px',
  lineHeight: 1.5,
