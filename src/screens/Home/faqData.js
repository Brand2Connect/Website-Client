...
const rows = [
  {
    title: "Do you store my paswords?",
    body: "No, your passwords are never entered into mediakits.com, all connections are done securely through the 1st party authentication window of each platform",
  },
  {
    title: "Do you sell my data?",
    body: "We do not, mediakits is a creator-first company, we do not sell user data to brands or 3rd party data companies.",
  },
  {
    title: "How do you calculate engagemenent rate?",
    body: "We divide the avg engagement count per cost by total followers on that platform to get the average engagement rate.",
  },
  {
    title: "Will Brand2Connect help me land brand deals?",
    body: "Brand2Connect are updated weekly for free users, brand2connect are updated daily for pro users and enterprise users.",
  },
  {
    title: "How often is my Brand2Connect updated?",
    body: "Brand2Connect are updated weekly for free users, brand2connect are updated daily for pro users and enterprise users.",
